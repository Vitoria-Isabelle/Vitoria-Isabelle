...
Seja bem-vindo(a) ao meu perfil! Sou estudante de **Análise e Desenvolvimento de Sistemas** e apaixonada por entender a lógica por trás das telas e construir soluções que resolvam problemas reais de forma inteligente.
...
Aqui estão as linguagens, ferramentas e conceitos com os quais tenho praticado e estudado ativamente:

* **Linguagens e Lógica:** JavaScript, Linguagem C, Python.
...
Aqui você encontra alguns dos projetos práticos que desenvolvi para consolidar meus aprendizados:

### 🎮 [StardewQuiz](https://github.com/Vitoria-Isabelle/StardewQuiz)
* **O que é:** Um web app de quiz interativo e responsivo sobre o universo do jogo Stardew Valley.
